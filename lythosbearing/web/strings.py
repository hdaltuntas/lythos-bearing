...
#: key -> (English, Turkish)
SHELL = {
    "tagline": ("bearing capacity of shallow foundations",
                "sığ temellerin taşıma gücü"),
    ...
    "methods_title": ("Bearing capacity by method", "Yönteme göre taşıma gücü"),
    ...
    "bad_file": ("That file is not a Lythos Bearing project.",
                 "Bu dosya bir Lythos Bearing projesi değil."),
...
REUSED = [
    ...
    "study_run", "study_cancel", "study_export_csv", "study_export_xlsx",
    "study_vars_group", "study_no_vars", "study_progress", "study_done", "study_failed",
    "study_no_data", "study_table_note",
]
